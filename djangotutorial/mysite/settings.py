...
SECRET_KEY = "django-insecure-is_1^cx*o*+^%@pv^z#*z8^ngihay1_&=9h^z_9h7pq+u86dqk"
...
INSTALLED_APPS = [
    ...
    "django.contrib.contenttypes",  # Framework dla typów sieci
...
MIDDLEWARE = [
    ...
    "debug_toolbar.middleware.DebugToolbarMiddleware",  # 3th-party toolbar
]
